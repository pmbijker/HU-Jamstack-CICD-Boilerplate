...
const client = contentful.createClient({
    space: 'abtn7s0kkxkw', // Insert Contentful Space ID
    accessToken: 'XAjRdwzFMwbeOXA4t7mFYM039NfzTtHSMVmesZzUGe8' // Insert Contentful Content Delivery API access token
});
